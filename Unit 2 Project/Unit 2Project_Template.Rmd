...
genre_sf <- c(rep("Success", 2348), rep("Faiure", 14369))
rating_sf <- c(rep("Success", 3991), rep("Failure", 12726))

table(genre_sf)
table(rating_sf)

prop.test(x = c(2348,3991), n = c(16717,16717), conf.level = 0.99)
...
by(nasplt$NA_Sales, wtsmk$Platform, summary)
by(wtsmk$NA_Sales, wtsmk$Platform, sd)
```
