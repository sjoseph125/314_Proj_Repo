...
twoway
ggplot(vgs, aes(fill=Rating, y=sum(vgs), x=Genre)) + geom_bar(position= 'stack', stat='identity') + ylab('Count') + xlab('Genre') + theme(axis.text.x=element_text(angle = -90, vjust = 0.5))
```
